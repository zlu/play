...
describe Connfu::Dsl do
  ...
  subject {
    DslTest.new(:from => "call-jid", :to => "client-address", :call_id => "call-id")
  }
  ...
  describe 'send_command' do
    it 'should be able to handle results with same id but different call id' do
      ...
      subject.send_command(Connfu::Commands::Say.new(:text => '', :from => 'client-address', :call_jid => 'call-jid'))
  ...
  describe 'say' do
    it 'should send Say command to connection' do
      ...
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Say.new(:text => text, :from => 'client-address', :call_jid => 'call-jid'))
      catch :waiting do
        subject.say(text)
      end
    end
  ...
  describe 'hangup' do
    it 'should send Hangup command to connection' do
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Hangup.new(:from => 'client-address', :call_jid => 'call-jid'))
      subject.hangup
    end
  end
  ...
  describe 'reject' do
    it 'should send Reject command to connection' do
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Reject.new(:from => 'client-address', :call_jid => 'call-jid'))
      subject.reject
    end
  end
  ...
  describe 'redirect' do
    it 'should send Redirect command to connection' do
      ...
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Redirect.new(:redirect_to => redirect_to, :from => 'client-address', :call_jid => 'call-jid'))
  ...
  describe 'transfer' do
    ...
    it 'should send Transfer command to connection' do
      ...
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Transfer.new(:transfer_to => [transfer_to], :from => 'client-address', :call_jid => 'call-jid'))
      catch :waiting do
    ...
    it 'should send Transfer command with optional timeout in milliseconds' do
      ...
      cmd = Connfu::Commands::Transfer.new(:transfer_to => [transfer_to], :from => 'client-address', :call_jid => 'call-jid', :timeout => (timeout_in_seconds * 1000))
  ...
  describe 'recording' do
    it 'should send a start command to connection' do
      ...
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Start.new(
        :from => 'client-address', :call_jid => 'call-jid'
      ))
    ...
    it 'should send a start command to connection with optional beep parameter' do
      subject.stub(:wait_for).and_return(Connfu::Event::Result.new)
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Start.new(
        :from => 'client-address', :call_jid => 'call-jid', :beep => false
      ))
    ...
    it 'should send a start command to connection with optional format parameter' do
      subject.stub(:wait_for).and_return(Connfu::Event::Result.new)
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Start.new(
        :from => 'client-address', :call_jid => 'call-jid', :format => :wav
      ))
    ...
    it 'should send a start command to connection with optional format and encoding parameters' do
      subject.stub(:wait_for).and_return(Connfu::Event::Result.new)
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Start.new(
        :from => 'client-address', :call_jid => 'call-jid', :format => :wav, :codec => :mulaw_pcm_64k
    ...
    it 'should send a start command to connection with optional timeout in milliseconds' do
      ...
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Start.new(
        :from => 'client-address', :call_jid => 'call-jid', :max_length => (max_length_in_seconds * 1000)
      ))
    ...
    it 'should send a start command to connection with optional timeout in milliseconds and beep parameter' do
      ...
      subject.stub(:wait_for).and_return(Connfu::Event::Result.new, Connfu::Event::RecordingStopComplete.new)
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Start.new(
        :from => 'client-address', :call_jid => 'call-jid', :max_length => (max_length_in_seconds * 1000), :beep => false
      ))
    ...
    it 'should send a start command to connection with optional timeout in milliseconds and format parameter' do
      ...
      subject.stub(:wait_for).and_return(Connfu::Event::Result.new, Connfu::Event::RecordingStopComplete.new)
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Start.new(
        :from => 'client-address', :call_jid => 'call-jid', :max_length => (max_length_in_seconds * 1000), :format => :wav
      ))
    ...
    it 'should send a start command to connection with optional timeout in milliseconds and format parameter and encoding codec' do
      ...
      subject.stub(:wait_for).and_return(Connfu::Event::Result.new, Connfu::Event::RecordingStopComplete.new)
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Start.new(
        :from => 'client-address', :call_jid => 'call-jid', :max_length => (max_length_in_seconds * 1000), :format => :wav, :codec => :mulaw_pcm_64k
      ))
    ...
    it 'should send a stop command to connection' do
      ...
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Recording::Stop.new(:from => 'client-address', :call_jid => 'call-jid', :ref_id => 'foo'))
  ...
  describe 'say' do
    it 'should send Ask command to connection and respond with captured input' do
      ...
      Connfu.connection.should_receive(:send_command).with(Connfu::Commands::Ask.new(:prompt => text, :from => 'client-address', :call_jid => 'call-jid', :digits => digits))
      catch :waiting do
