  ...
  describe "generating XMPP iq" do
    describe "for the Dial command" do
      ...
      describe 'dial node' do
        it 'should exist' do
          subject.xpath("//x:dial", "x" => "urn:xmpp:rayo:1").size.should eq 1
        end

        it 'should have correct to and from attributes' do
          node = subject.xpath("//x:dial", "x" => "urn:xmpp:rayo:1").first
    ...
    describe "for the Dial command with custom headers" do
      ...
      describe 'dial headers' do
        it 'should exist' do
          subject.xpath("//x:dial/x:header", "x" => "urn:xmpp:rayo:1").size.should eq 1
        end

        it 'should have the correct attributes' do
          node = subject.xpath("//x:dial/x:header", "x" => "urn:xmpp:rayo:1").first
