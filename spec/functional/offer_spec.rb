...
describe "handling a call offer" do
  ...
  it "exposes who the call is from" do
    ...
    incoming :offer_presence, @call_jid, @client_address, :from => "James Adam <sip:james@127.0.0.1>"
  end
  ...
  it "exposes who the call is being routed to" do
    ...
    incoming :offer_presence, @call_jid, @client_address, :to => "<sip:usera@127.0.0.1>"
  end
