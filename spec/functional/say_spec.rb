...
describe "say something on a call" do
  ...
  it "should send first say command" do
    ...
    Connfu.connection.commands.last.should == Connfu::Commands::Say.new(:text => 'hello, this is connfu', :call_jid => @call_jid, :from => @client_address)
  end
  ...
  it "should send the second say command once the first say command has completed" do
    ...
    Connfu.connection.commands.last.should == Connfu::Commands::Say.new(:text => 'http://www.phono.com/audio/troporocks.mp3', :call_jid => @call_jid, :from => @client_address)
  end
end