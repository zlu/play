...
describe "a call transfer" do
  ...
  it "should send a transfer command" do
    ...
    Connfu.connection.commands.last.should == Connfu::Commands::Transfer.new(:transfer_to => ['sip:userb@127.0.0.1'], :call_jid => @call_jid, :from => @client_address)
  end
  ...
  it "should indicate that the call has been transferred successfully" do
    ...
    Connfu.connection.commands.last.should == Connfu::Commands::Say.new(:text => 'transfer was successful', :call_jid => @call_jid, :from => @client_address)
  end
  ...
  it "should indicate that the call transfer has been timed out" do
    ...
    Connfu.connection.commands.last.should == Connfu::Commands::Say.new(:text => 'sorry nobody is available at the moment', :call_jid => @call_jid, :from => @client_address)
  end
end
...
describe "a round-robin call transfer" do
  ...
  it "should send a transfer command for the second sip address if the first one times out" do
    ...
    Connfu.connection.commands.last.should == Connfu::Commands::Transfer.new(:transfer_to => ['sip:userc@127.0.0.1'], :call_jid => @call_jid, :from => @client_address)
  end
...
describe "A transfer that was rejected" do
  ...
  it "should indicate that the transfer was rejected by the end-point" do
    ...
    Connfu.connection.commands.last.should == Connfu::Commands::Say.new(:text => 'transfer was rejected', :call_jid => @call_jid, :from => @client_address)
  end
end
...
describe "A transfer that was rejected because far end is busy" do
  ...
  it "should indicate that the transfer was rejected because far-end is busy" do
    ...
    Connfu.connection.commands.last.should == Connfu::Commands::Say.new(:text => 'transfer was rejected because far-end is busy', :call_jid => @call_jid, :from => @client_address)
  end
end