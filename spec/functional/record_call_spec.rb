...
describe "Recording a call" do
  ...
  describe "with explicit stop command" do
    ...
    it "should send first record start command" do
      ...
      Connfu.connection.commands.last.should == Connfu::Commands::Recording::Start.new(:call_jid => @call_jid, :from => @client_address)
    end
    ...
    it "should send the stop recording command with the recording ID when start recording has been sent" do
      ...
      Connfu.connection.commands.last.should == Connfu::Commands::Recording::Stop.new(:call_jid => @call_jid, :from => @client_address, :ref_id => @recording_ref_id)
    end
